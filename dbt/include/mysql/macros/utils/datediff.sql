{% macro mysql__datediff(first_date, second_date, datepart) -%}
    ...
    {% else %}
        {{ exceptions.raise_compiler_error("Unsupported datepart for macro datediff in mysql: {!r}".format(datepart)) }}
    {% endif %}
