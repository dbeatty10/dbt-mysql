...
`pip install git+ssh://git@github.com/dbeatty10/dbt-adapter-tests.git@mysql#egg=pytest-dbt-adapter`

#### Install via HTTPS

`pip install git+https://github.com/dbeatty10/dbt-adapter-tests.git@mysql#egg=pytest-dbt-adapter`
